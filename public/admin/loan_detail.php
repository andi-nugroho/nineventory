...
if (!$loanDetails) {
    ...
    header("Location: loans.php?error=notfound");
    exit;
}
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm">
                        <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">Details of the loan request.</p>
                            </div>
                            <a href="loans.php" class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg font-medium hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors text-sm">
                                Back to Loans
                            </a>
                        </div>
                        ...
                        <div class="p-6 space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                    <span class="block text-sm text-gray-500 dark:text-gray-400">Requester</span>
                                    <span class="font-bold text-lg text-gray-900 dark:text-white"><?= htmlspecialchars($loanDetails['username']) ?></span>
                                </div>
                                <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                    ...
                                    <table class="w-full text-left">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="border-t dark:border-gray-700">
                                                <td class="px-4 py-3 font-medium text-gray-900 dark:text-white"><?= htmlspecialchars($detail['nama_barang']) ?></td>
